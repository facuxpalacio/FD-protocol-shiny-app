...
alt="The graphical user interface (GUI) of divan after loading a community matrix. (a) Sidebar menu, (b) heatmap plus dendrogram of the community matrix, (c) rarefaction curves of individual sites. " />
<figcaption aria-hidden="true">The graphical user interface (GUI) of
<strong>divan</strong> after loading a community matrix. (a) Sidebar
menu, (b) heatmap plus dendrogram of the community matrix, (c)
...
alt="The GUI of divan after loading a trait matrix. (a) Sidebar menu, (b) selection of functional traits for analysis and plotting, (c) Principal Coordinate Analysis (PCoA) inputs, (d) biplot of species and functional traits plus density kernel surface." />
<figcaption aria-hidden="true">The GUI of divan after loading a trait
matrix. (a) Sidebar menu, (b) selection of functional traits for
